...
<body class="g-sidenav-show  bg-gray-100" >
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y" id="sidenav-main">
    <div class="sidenav-header" style="margin-bottom: 10px; display: grid;justify-items: center;">
      @auth
      <img style="width:30px;" src="{{Auth::user()->profile_photo_path}}"/>
    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link @if(url()->current() == url('/events')) active @endif" href="{{ url('/events') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          @auth
        <li class="nav-item">
          <a class="nav-link @if(url()->current() == url('/events/create')) active @endif" href="{{route('events.create')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 @endauth
        ...
        <li class="nav-item">
          <a class="nav-link @if(url()->current() == url('/users')) active @endif" href="{{url('users')}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 @else
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ps">
    ...
    @else 
    <a href="{{ url('/login') }}" class="btn btn-sm btn-primary mb-2 mr-2"><i class="fa fa-user me-sm-1" aria-hidden="true" ></i> Connexion </a> 
    @endauth
              </a>
