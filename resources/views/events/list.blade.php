@extends('template')
@section('title') Les événements @endsection
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold">{{strftime('%d/%m/%Y à %H:%m',
                                strtotime($events->date))}}</span>
                        </td>
                        <td class="align-middle">
                            <a href="{{route('events.show', $events->id)}}" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-original-title="Edit user">
                                Consulter
                            </a>
                        </td>
                    </tr>
