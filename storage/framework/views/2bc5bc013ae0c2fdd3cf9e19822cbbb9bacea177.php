              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="d-flex flex-column h-100">
                    ...
                    <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="<?php echo e(route('news.create')); ?>">
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100" style="background-image: url(https://static.cnews.fr/sites/default/files/styles/image_880_495/public/williams.jpg?itok=R8BsH-0y);">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                ...
                <a class="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="<?php echo e(url('/news')); ?>">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtar0001/public_html/PlayersGathering2.0/resources/views/index.blade.php ENDPATH**/ ?>