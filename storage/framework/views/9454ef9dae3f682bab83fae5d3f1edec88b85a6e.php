...
<table >
  <tbody>
    ...
    <tr>
      ...
      <td><form action="<?php echo e(route('users.destroy', $users->id)); ?>" method="POST">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mtar0001/public_html/playersg/resources/views/events/ListeUtilisateur.blade.php ENDPATH**/ ?>