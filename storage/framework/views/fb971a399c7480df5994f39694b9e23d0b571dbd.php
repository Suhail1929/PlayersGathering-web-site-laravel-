...
<meta name="csrf-token" content="<?php echo e(csrf_token()); ?>" />
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://cdn2.iconfinder.com/data/icons/basic-ui-elements-16/117/gamepad-256.png" />
    <!-- CSS Files -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/design.css')); ?>">
...
<body class="g-sidenav-show  bg-gray-100" >
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto max-height-vh-100 h-100 ps" id="sidenav-collapse-main">
      ...
      <li class="nav-item">
          <a class="nav-link  <?php if(url()->current() == url('/')): ?> active <?php endif; ?>" href="<?php echo e(url('/')); ?>">
            ...
            <span class="nav-link-text ms-1">Page d'accueil</span>
          </a>
        </li>


        <li class="nav-item">
          <a class="nav-link <?php if(url()->current() == url('/events')): ?> active <?php endif; ?>" href="<?php echo e(url('/events')); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <?php if(auth()->guard()->check()): ?>
        <li class="nav-item">
          <a class="nav-link <?php if(url()->current() == url('/events/create')): ?> active <?php endif; ?>" href="<?php echo e(route('events.create')); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 <?php endif; ?>
        ...
        <li class="nav-item">
          <a class="nav-link <?php if(url()->current() == url('/users')): ?> active <?php endif; ?>" href="<?php echo e(url('users')); ?>">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
 ...
 <?php else: ?>
  ...
  <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 0px; right: 0px;"></div></aside>
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-0 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <?php echo $__env->yieldContent('rechercheBarre'); ?>
          </div>
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                 ...
                 <?php if(auth()->guard()->check()): ?>
    <button type="submit" form="formLogout" class="btn btn-sm btn-danger mb-2 mr-2"><i class="fa fa-user me-sm-1" aria-hidden="true" ></i> Déconnexion </button>
    <?php else: ?> 
    <a href="<?php echo e(url('/login')); ?>" class="btn btn-sm btn-primary mb-2 mr-2"><i class="fa fa-user me-sm-1" aria-hidden="true" ></i> Connexion </a> 
    <?php endif; ?>
              </a>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <form id="formLogout" action="<?php echo e(url('/logout')); ?>" method="POST"> <?php echo csrf_field(); ?>
</form> 
...
<iframe name="_hjRemoteVarsFrame" title="_hjRemoteVarsFrame" id="_hjRemoteVarsFrame" src="https://vars.hotjar.com/box-d09a446edefba0dcce5d5143e1840e9a.html" style="display: none !important; width: 1px !important; height: 1px !important; opacity: 0 !important; pointer-events: none !important;"></iframe>
...
$(document).ready(function(){
 ...
 function fetch_customer_data(query = '')
 {
  $.ajax({
   ...
   {
    $('.tableevent').html(data.table_data);
...
</html><?php /**PATH /home/garz0002/public_html/projetinfo303/resources/views/template.blade.php ENDPATH**/ ?>