<?php $__env->startSection('title'); ?> Les événements <?php $__env->stopSection(); ?>
<?php $__env->startSection('rechercheBarre'); ?>
  <div class="input-group">
    <span class="input-group-text text-body"><i class="fas fa-search" aria-hidden="true"></i></span>
    <input type="text" name="search" id="search" class="form-control" placeholder="Rechercher un événement..." />
  </div>
    ...
    <div class="table-responsive p-0">
        <div class="scrollit">
            <table class="table align-items-center mb-0" class="table">
                <thead>
                    <tr>
                        <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Evénement</th>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex px-2 py-1">
                                <div>
                                    <img src="https://cdn2.iconfinder.com/data/icons/basic-ui-elements-16/117/gamepad-256.png"
                        ...
                        <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold"><?php echo e(strftime('%d/%m/%Y à %H:%m',
                                strtotime($events->date))); ?></span>
                        </td>
                        <td class="align-middle">
                            <a href="<?php echo e(route('events.show', $events->id)); ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-original-title="Edit user">
                                Consulter
                            </a>
                        </td>
                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/garz0002/public_html/projetinfo303/resources/views/events/list.blade.php ENDPATH**/ ?>