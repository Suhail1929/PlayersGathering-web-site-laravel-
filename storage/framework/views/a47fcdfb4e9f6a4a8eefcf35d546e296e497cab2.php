<?php $__env->startSection('title'); ?> Création d'un événement <?php $__env->stopSection(); ?>
...
unset($__errorArgs, $__bag); ?>" name="title" id="title" placeholder="Saisir le titre de l'événement " value="<?php echo e(old('title')); ?>"/>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" name="NumP" id="NumP" placeholder="Saisir le nombre de participant maximale" value="<?php echo e(old('NumP')); ?>"/>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" name="date" id="date" placeholder="Saisir la date de l'événement " value="<?php echo e(old('date')); ?>"/>
            </div>
        </div>
...
unset($__errorArgs, $__bag); ?>" id="message" name="message" placeholder="Décrivez votre événement"> <?php echo e(old('message')); ?></textarea>
            </div>
        </div>
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/garz0002/public_html/projetinfo303/resources/views/events/create.blade.php ENDPATH**/ ?>